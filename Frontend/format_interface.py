...
button_fat32 = tk.Button(format_window, text="FAT32", command= 0, font=("Arial", 14), bg="lightblue", width=15, height=2) #  choisir_format("FAT32")
button_fat32.pack(pady=10)

button_windows = tk.Button(format_window, text="Windows", command=0 , font=("Arial", 14), bg="lightgreen", width=15, height=2) # choisir_format("Windows")
button_windows.pack(pady=10)

button_linux = tk.Button(format_window, text="Linux", command=0 , font=("Arial", 14), bg="lightcoral", width=15, height=2) # choisir_format("Linux")
button_linux.pack(pady=10)

button_quitter = tk.Button(format_window, text="Quitter", command=quitter, font=("Arial", 14), bg="lightgrey", width=15, height=2)
